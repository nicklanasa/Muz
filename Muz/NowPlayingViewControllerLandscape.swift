//
//  NowPlayingViewControllerLandscape.swift
//  Muz
//
...
class NowPlayingViewControllerLandscape: RootViewController,
NowPlayingCollectionControllerDelegate {
    ...
    init(song: Song) {
        super.init(nibName: "NowPlayingViewControllerLandscape", bundle: nil)
        configureWithItem()
    }
